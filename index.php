...
<body style="background-image:url('rata turca 3.png');">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            <li class="nav-item" style="padding-right: 10px;">
                <form action="cronograma.php" method="get">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #081F75; border-color:#081F75;"><?php echo $row['año']; ?></button>
                </form>
            </li>
        <?php
            }
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="hola.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="chino.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="enano.jpg" class="d-block w-100" alt="...">
                        </div>
